...
class StrmManager:
	...
	def getTMDBtitle(self, type, title, year):
		...
		if type == "episode":
			url = "https://www.themoviedb.org/search/tv?" + urllib.urlencode(params)
		else:
			url = "https://www.themoviedb.org/search/movie?" + urllib.urlencode(params)
		...
		# url = "https://www.imdb.com/find?" + urllib.urlencode(params)
